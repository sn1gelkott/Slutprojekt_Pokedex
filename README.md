...
Det här projektet är ett Pokédex där man kan filtrera Pokémon utifrån vilken generation de tillhör och om de är "legendaries" eller inte.
Jag har valt att göra det möjligt att visa Pokémon upp till generation 4, dels för att jag inte var säker
